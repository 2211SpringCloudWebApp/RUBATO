                ...
                <ul id ="ulTable">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="left"><a href="/board/detail?boardNo=${board.boardNo }" id="boardTitlecss">${board.boardTitle }</a></li>
                            ...
                            <div id="searchDIV">
                                <form action="/board/search" method="get">
	                                <select id='selSearchOption' name="searchCondition">
	                                    <option value='1' <c:if test="${search.searchCondition == 'A' }">selected</c:if>>제목+내용</option>
	                                    <option value='2' <c:if test="${search.searchCondition == 'T' }">selected</c:if>>제목</option>
	                                    <option value='3' <c:if test="${search.searchCondition == 'C' }">selected</c:if>>내용</option>
	                                </select>
	                                <input type="text" id='txtKeyWord' name="searchValue" value="${search.searchValue }" placeholder="검색어를 입력하세요." />
