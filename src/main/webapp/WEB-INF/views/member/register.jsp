		        ...
		        <form action="/member/register" method="POST">
		            <table>
		                ...
		                <tr>
		                    ...
		                    <td>
		                        <input type="password" name="memberPwd" class="input-box" placeholder="패스워드를 입력하세요" maxlength="16">
		                        <p id="required-pwd">
		                ...
		                <tr>
		                    ...
		                    <td>
		                        <input type="password" name="memberPwd2" class="input-box" placeholder="패스워드를 다시 입력하세요" maxlength="16">
		                    </td>
		                </tr>
		                <tr>
		                    <th>이름 <span>*</span></th>
		                ...
		                <tr>
		                    <th>연락처 <span>*</span></th>
		                    <td><input type="text" name="memberPhone" class="input-box" placeholder="하이픈(-)을 제외하고 입력하세요" maxlength="11"></td>
		                </tr>
		                <tr>
		                    <th>주소 <span>*</span></th>
		                    <td>
